...
ids = c( c(1,4,7,10,13,16,19,22,25,28,31) , c(1,4,7,10,13,16,19,22,25,28,31) + 1 , c(1,4,7,10,13,16,19,22,25,28,31) + 2)
...
p = ggarrange(plotlist = plots , nrow = 3 , ncol = 11 , common.legend = T)
p
