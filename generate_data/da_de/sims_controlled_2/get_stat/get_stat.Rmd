...
stat = merge(stat , unique(stat_da[, c("id_sim" , "n_markers" , "n_not_markers", "round_sim" , "order" , "k" , "seed" , "id_nhood_assignment" , "reducedDim_name")]) , by = c("id_sim" , "id_nhood_assignment" , "reducedDim_name") , all.x = T , all.y = F)

saveRDS(stat , file = paste0(root.dir , "data/processed/da_de/simulations_controlled/stat_combined_all_genes.Rds"))
