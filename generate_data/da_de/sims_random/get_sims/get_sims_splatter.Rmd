...
rowdata$avg_counts = rowMeans(counts(sim))
...
genes_2_simulate = lapply(1:nrow(anno) , function(i){
  ...
  out$range = ceiling(out$avg_counts/2)
  return(out)
})
...
names(sces) = anno$id
saveRDS(sces , file = paste0(root.dir , "data/processed/da_de/simulations_random/sims.Rds"))
...
names(genes_2_simulate) = anno$id
saveRDS(genes_2_simulate , file = paste0(root.dir , "data/processed/da_de/simulations_random/simulated_genes.Rds"))
