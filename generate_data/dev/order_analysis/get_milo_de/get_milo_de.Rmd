...
stat = lapply(1:nrow(anno) , function(i){
  proc.file = paste0(root.dir ,  "data/processed/order_analysis/proc/" , anno$order[i] , "_k_" , anno$k[i] , "_round_" , anno$round[i], ".Rds")
  if (!file.exists(proc.file)){
    out.proc = 1
    saveRDS(out.proc , paste0(root.dir ,  "data/processed/order_analysis/proc/" , anno$order[i] , "_k_" , anno$k[i] , "_round_" , anno$round[i], ".Rds"))
    ...
    saveRDS(stat_de , file = paste0(root.dir ,  "data/processed/order_analysis/milo_de_selected/" ,"milo_de_order_", anno$order[i] , "_k_" , anno$k[i] , "_round_" , anno$round[i], ".Rds"))
